...
Analogously with the example from the previous section, designers ought to face certain trade-offs when developing applications. I other words, the framework helps exposing the gaps; however, it is up to designers whether or not those gaps need to be closed.
