...
\textbf{Integration.} Similarly to serendipitous discovery, if an information discovery application gives access to resources from other Websites, the user should be able to navigate to those sites since they may contain the facts of interest.
...
\textbf{User subscription.} Similar to site subscriptions, user subscriptions, which are subscriptions to activity updates from individual users rather than all of the content updates, help networking and following users' activities ~\cite{millen}. Such subscriptions help to further filter new content delivered to the user.
